...
Page({
	...
	dragDown(e) {
		console.log(e);
		let list = this.data.listData2;
		let destKey = this.drag2.getKeyByClientX(e.detail.clientX);
		list.splice(destKey, 0, e.detail.item);
		this.setData({listData2:list})
		this.drag2.init(true);
	},
	add(e) {
